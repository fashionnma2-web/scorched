// ============================================================
// AGENTSCAN — Neo4j Graph Schema for X Layer Agent Commerce
...
// agentscan_indexer.go's runNeo4jSync), which is exactly what the risk
...
// in agentscan_api.go. This is the actual differentiator over generic
// ERC-8004 explorers (8004scan.io, agentscan.info) — they show a
...
// agentscan_riskscan.go) rather than here, since it's a simple filter
...
// version of this check also runs in SQL (see agentscan_riskscan.go),
