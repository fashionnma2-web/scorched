...
// getEnvUint64 parses a numeric env var, falling back on missing/invalid values.
...
const checkpointKey = "agentscan:last_block"
...
func (idx *Indexer) Start() error {
	log.Println("🚀 AgentScan Indexer starting...")
	...
	// Start risk/fraud detection scans — AgentScan's differentiator, see
