...
// ============================================================
// AGENTSCAN — Risk & Fraud Detection Scanner
//
// This is AgentScan's actual differentiator vs. generic ERC-8004 explorers
// (8004scan.io, agentscan.info) — see AUDIT.md for that market-research
...
// agentscan_api.go / HANDOFF.md) can push them live. This is intentionally
// its own file/concern, kept separate from the event-indexing logic in
// agentscan_indexer.go, even though today it runs in the same binary and
...
// Runs the R1 Cypher query from agentscan_neo4j_schema.cypher against the
